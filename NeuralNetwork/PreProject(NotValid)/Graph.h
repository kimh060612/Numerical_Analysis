...
public:
	...
	Graph(int type_Block, Function *Error); // type 1, Last Layer Graph Layer_block[0] :: Error function
	//Graph(int type_Block); // type 2, CNN Graph
	//Graph(int type_Block); // type 3, Pooling Graph
	~Graph();
